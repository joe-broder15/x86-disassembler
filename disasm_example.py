        ...
        if isValidOpcode(opcode):
            ...
            if 1:
                ...
                if li[1] == True:
                    ...
                    if li[0] == None:
                        print(
                            "Need to look at the REG field modrm for the opcode extension"
                        )
                        mnemonic = "UPDATEME"
                    ...
                    if implemented == True:
                        ...
                        outputList["%08X" % orig_index] = (
                            instruction_bytes + " " + instruction
                        )
                    else:
                        outputList["%08X" % orig_index] = "db %02x" % (
                            int(opcode) & 0xFF
                        )
                else:
                    print(
                        "Does not require MODRM - modify to complete the instruction and consume the appropriate bytes"
                    )
